...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # layoutV2.setContentsMargins(0,0,0,0)
        splitterV2.addWidget(mask_config_widget)
        splitterV2.addWidget(import_target_list_display)
        splitterV2.setOrientation(Qt.Orientation.Vertical)
        splitterV2.setContentsMargins(0,0,0,0)
        # widgetV2 = QWidget()
        # widgetV2.setLayout(layoutV2) 
        #for layoutv2 we definitely make that another splitter
